...
from ppq.core import ChannelwiseTensorQuantizationConfig, DataType, QuantizationStates
    ...
    def export_quantization_config(self, config_path: str, graph: BaseGraph):
        ...
        for operation in topo_order:
            ...
            for config, var in operation.config_with_variable:
                ...
                if config.state == QuantizationStates.SLAVE and var.name in activation_info:
                    continue

                assert not isinstance(config, ChannelwiseTensorQuantizationConfig), (
        ...
        exports = {"activation_encodings": activation_info, "param_encodings": param_info}
