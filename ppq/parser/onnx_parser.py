...
from ppq.core import DEFAULT_OPSET_DOMAIN, DEFAULT_OPSET_VERSION, GRAPH_OPSET_ATTRIB, is_file_exist, NetworkFramework
...
class OnnxParser(GraphBuilder):
    ...
    def de_inplace(self, graph: BaseGraph) -> BaseGraph:
        """Remove inplace layer in netdef If the names of bottom and top are
        same, it means the computation of this layer is in place."""
