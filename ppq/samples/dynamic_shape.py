...
if YOU_WANT_TO_QUANTIZE_IT:
    ir = dispatch_graph(ir, platform=TargetPlatform.NCNN_INT8, setting=QuantizationSettingFactory.ncnn_setting())
...
export_ppq_graph(
    graph=ir, platform=TargetPlatform.NCNN_INT8, graph_save_to="onnx model save to", config_save_to="config save to"
)
