...
from ppq.quantization.optim import NCNNFormatGemmPass, QuantizationOptimizationPipeline
        ...
        if operation.type in {"Conv", "Gemm"}:
            ...
            if operation.type == "Conv":
                ...
                base_quant_config.input_quantization_config[
                    ...
                    convert_from=conv_weight_config, offset=None, scale=None, channel_axis=0
                )
                ...
                if (
                    group == 1
                    and all([i == 1 for i in dilations])
                    and all([j == 1 for j in strides])
                ...
                assert (
                    operation.attributes.get("transB", 0)
                    and operation.attributes.get("alpha", 1.0) == 1.0
                ...
                base_quant_config.input_quantization_config[
                    ...
                    convert_from=gemm_weight_config, offset=None, scale=None, channel_axis=0
                )
                base_quant_config.input_quantization_config[1].observer_algorithm = "Minmax"
