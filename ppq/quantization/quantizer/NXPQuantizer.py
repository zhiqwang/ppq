...
from ppq.quantization.optim import NxpInputRoundingRefinePass, NXPResizeModeChangePass, QuantizationOptimizationPipeline
        ...
        if operation.type in {"Conv", "ConvTranspose", "Gemm"}:
            ...
            if operation.num_of_input > 2:
                ...
                base_quant_config.input_quantization_config[
                    ...
                    convert_from=bias_config, offset=None, scale=None, channel_axis=0
                )
                base_quant_config.input_quantization_config[-1].observer_algorithm = "Minmax"
