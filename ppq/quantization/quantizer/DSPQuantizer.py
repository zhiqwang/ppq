...
from ppq.quantization.optim import PPLDSPTIReCalibrationPass, QuantizationOptimizationPipeline
        ...
        if operation.type in {"Conv", "ConvTranspose", "Gemm"}:
            ...
            if operation.type == "Conv":
                ...
                base_quant_config.input_quantization_config[
                    ...
                    convert_from=conv_weight_config, offset=None, scale=None, channel_axis=1
                )
                base_quant_config.input_quantization_config[1].observer_algorithm = "Minmax"
