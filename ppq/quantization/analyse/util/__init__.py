...
class MeasurePrinter:
    ...
    def __init__(
        self, data: Dict[str, float], measure: str, label: str = "Layer", k: int = None, order: str = "large_to_small"
    ) -> None:
        ...
        if order is None:
            ...
            largest_element, smallest_element = self.collection[-1][1], self.collection[0][1]
