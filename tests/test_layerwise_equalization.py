    ...
    def __init__(self) -> None:
        ...
        with torch.no_grad():
            ...
            self.conv2 = torch.nn.Conv2d(
                in_channels=32, out_channels=32, groups=16, kernel_size=3, stride=1, padding=1, bias=False
            )
            ...
            self.convtranspose2 = torch.nn.ConvTranspose2d(
                in_channels=32, out_channels=32, groups=32, kernel_size=3, stride=2, bias=False
            )
...
class MyModel(torch.nn.Module):
    def __init__(self) -> None:
        ...
        with torch.no_grad():
            ...
            self.conv3 = torch.nn.ConvTranspose1d(
                in_channels=32, out_channels=8, groups=8, kernel_size=5, stride=1, padding=2
            )
...
class MyModel(torch.nn.Module):
    def __init__(self) -> None:
        ...
        with torch.no_grad():
            ...
            self.conv2 = torch.nn.ConvTranspose3d(
                in_channels=32, out_channels=32, groups=16, kernel_size=3, stride=1, padding=1, bias=False
            )
